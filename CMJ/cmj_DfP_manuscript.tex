...
\lfoot{\small \emph{manuscript under review}} % remove and will revert to CMJ footer.
...
% \citep[\emph{reference removed for anonymity} (forthcoming), ][]{Wallis2013}, 
...
% {\emph{university name removed for anonymity}}
McGill University
